export const CYCLE_SNAPSHOTS_LENGTH = 1000;
...
export const NANOS_PER_WEEK = 7n * NANOS_PER_DAY;
export const NANOS_PER_MONTH = 4n * NANOS_PER_WEEK;
export const NANOS_PER_YEAR = 12n * NANOS_PER_MONTH;
